...
import { 
  Users, Store, Wifi, DollarSign, Percent, Calendar, 
  TrendingUp, Clock, Star, Bell, Download, Filter
} from 'lucide-react';
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const mockData = {
        ...
        revenueHistory: [
          { name: 'Lun', totalRevenue: 450000, zoomWifiCommission: 180000, users: 120 },
          { name: 'Mar', totalRevenue: 520000, zoomWifiCommission: 208000, users: 145 },
          { name: 'Mer', totalRevenue: 480000, zoomWifiCommission: 192000, users: 132 },
          { name: 'Jeu', totalRevenue: 590000, zoomWifiCommission: 236000, users: 168 },
          { name: 'Ven', totalRevenue: 620000, zoomWifiCommission: 248000, users: 172 },
          { name: 'Sam', totalRevenue: 750000, zoomWifiCommission: 300000, users: 198 },
          { name: 'Dim', totalRevenue: 680000, zoomWifiCommission: 272000, users: 185 }
        ],
        userActivity: [
          { time: '00:00', users: 45 },
          { time: '03:00', users: 30 },
        ...
        alerts: [
          { id: 1, type: 'partner_pending', message: 'Nouveau partenaire en attente : Restaurant Le Délice' },
          { id: 2, type: 'withdrawal', message: 'Nouvelle demande de retrait : 75,000 FCFA - Cyber Café Express' },
          { id: 3, type: 'long_session', message: 'Session > 4h détectée : Hôtel Magnificence' },
          { id: 4, type: 'usage_peak', message: 'Pic d\'utilisation détecté : +150% utilisateurs actifs' }
        ]
      };
    ...
    <div className="animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="card p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600">{t('dashboard.partners')}</p>
        ...
        <div className="card p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600">{t('dashboard.active_connections')}</p>
        ...
        <div className="card p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600">{t('dashboard.zoom_commission')}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 mb-8">
        <div className="card p-6 lg:col-span-3">
          <h2 className="text-lg font-semibold text-gray-900 mb-6">Performance des Revenus</h2>
        ...
        <div className="card p-6 lg:col-span-2">
          <h2 className="text-lg font-semibold text-gray-900 mb-6">Indicateurs Clés</h2>
          <div className="space-y-6">
            <div>
              <div className="flex justify-between items-center mb-2">
                <span className="text-sm text-gray-600">Taux de conversion partenaires</span>
                <span className="text-lg font-bold text-gray-900">{stats.kpis.partnerConversionRate}%</span>
              </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="text-lg font-bold text-gray-900">{stats.kpis.averageSessionDuration}</span>
              </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="text-lg font-bold text-gray-900">{stats.kpis.arpu} FCFA</span>
              </div>
              <div className="flex items-center">
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <div className="flex items-center">
                  <span className="text-lg font-bold text-gray-900 mr-1">{stats.kpis.satisfactionRate}</span>
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="text-lg font-bold text-gray-900">{stats.kpis.fiberUsageRate}%</span>
              </div>
              <div className="flex items-center">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        <div className="card p-6 lg:col-span-2">
          <h2 className="text-lg font-semibold text-gray-900 mb-6">Utilisation par Heure</h2>
          <div className="h-[300px]">
            <ResponsiveContainer width="100%" height="100%">
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="relative">
              <div className="absolute -top-2 -right-2 w-5 h-5 bg-red-500 rounded-full flex items-center justify-center">
                <span className="text-xs text-white font-medium">{alerts?.length || 0}</span>
              </div>
